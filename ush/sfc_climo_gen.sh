...
input_canopy_forest_height_file="${input_sfc_climo_dir}/canopy_forest_height.0.01.nc"
input_canopy_clumping_index_file="${input_sfc_climo_dir}/canopy_clumping_index.0.01.nc"
input_canopy_leaf_area_index_file="${input_sfc_climo_dir}/canopy_leaf_area_index.0.01.nc"
input_canopy_forest_fraction_file="${input_sfc_climo_dir}/canopy_forest_fraction.0.01.nc"
