...
!! @author George Gayno @date 2018
 ...
 character(len=500), public   :: input_canopy_height_file = "NULL" !< File containing input canopy height data.
...
!! @author George Gayno @date 2018
 ...
 namelist /config/ input_facsf_file, input_substrate_temperature_file, &
                   ...
                   input_canopy_height_file, input_canopy_clumping_index_file,&
